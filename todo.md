...
## Corrigir Bugs Críticos do Dashboard

- [x] Excluir PRONTOS e ENTREGUES do cálculo de veículos atrasados
- [x] Corrigir tempo médio por etapa (forçar refresh ao expandir widget)
- [x] Corrigir mapa da oficina (forçar refresh ao expandir widget)
- [x] Testar todas as correções (dashboard funcionando corretamente)
